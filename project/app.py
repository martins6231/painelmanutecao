...
# Título principal
st.markdown('<div class="main-title">Análise de Disponibilidade de Máquinas</div>', unsafe_allow_html=True)
...
st.markdown("""
<div class="footer">
    <p>© 2025 Análise de Disponibilidade de Máquinas | Desenvolvido com ❤️ usando Streamlit</p>
