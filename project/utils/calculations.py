...
def calculate_availability(df, scheduled_time):
    ...
    # Desconta tempo do PCP do tempo programado
    adjusted_scheduled_time = scheduled_time - pcp_stops
    
    # Calcula disponibilidade considerando apenas paradas não-PCP
