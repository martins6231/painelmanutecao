...
translations = {
    "pt": {
        ...
        "total_duration_by_machine": "Duração Total por Máquina",
        ...
        "overall_deterioration": "Deterioração Geral",
        "performance_unchanged": "Desempenho Inalterado",
        "equal_improvements_deteriorations": "Número igual de melhorias e deteriorações",
        ...
        "recommendations": "Recomendações",
        "excellent_performance_continue": "Excelente desempenho! Continue com as práticas atuais",
        "document_improvements": "Documente as melhorias implementadas para referência futura",
        "set_higher_goals": "Estabeleça metas mais ambiciosas para o próximo período",
        "good_progress_focus_weak_areas": "Bom progresso! Foque nas áreas que ainda precisam de melhoria",
        "analyze_improvement_factors": "Analise os fatores que contribuíram para as melhorias",
        "implement_targeted_actions": "Implemente ações direcionadas para as áreas com desempenho inferior",
        "identify_priority_metrics": "Identifique os indicadores prioritários para melhoria",
        "establish_improvement_plan": "Estabeleça um plano de melhoria estruturado",
        "conduct_root_cause_analysis": "Realize análise de causa raiz para os problemas identificados",
        "urgent_action_needed": "Ação urgente necessária para reverter a tendência negativa",
        "conduct_detailed_investigation": "Conduza uma investigação detalhada dos fatores de deterioração",
        "develop_comprehensive_action_plan": "Desenvolva um plano de ação abrangente",
        "establish_monitoring_mechanisms": "Estabeleça mecanismos de monitoramento mais rigorosos",
        "download_comparison": "Baixar comparação",
        ...
        # Error messages
        "no_data_loaded": "Nenhum dado foi carregado. Por favor, vá para a página 'Painel Principal' e faça o upload de um arquivo Excel.",
